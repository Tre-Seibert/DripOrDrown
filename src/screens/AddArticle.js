...
export default function AddArticle({ navigation: { goBack } }) {
    ...
    async function registerPress(name, weather) {
        ...
        try {
            ...
            if (user.exists()) {
                console.log(
                    `name: ${name}, email: ${email}, type: ${type}, weather: ${weather}, size: ${size}, url: ${url}`
                );
            ...
            <View style={styles.container}>
                ...
                <View style={styles.inputView2}>
                    <TouchableWithoutFeedback onPress={onPressT}>
                        <View
                            style={
                                pressedT ? styles.btnNormal : styles.btnPress
                            }
                        >
                            <Text> SHIRT </Text>
                        </View>
                    ...
                    <TouchableWithoutFeedback onPress={onPress1T}>
                        <View
                            style={
                                pressed1T ? styles.btnNormal : styles.btnPress
                            }
                        >
                            <Text> PANTS </Text>
                        </View>
                    ...
                    <TouchableWithoutFeedback onPress={onPress2T}>
                        <View
                            style={
                                pressed2T ? styles.btnNormal : styles.btnPress
                            }
                        >
                            <Text> DRESS </Text>
                        </View>
                ...
                <View style={styles.inputView2}>
                    <TouchableWithoutFeedback onPress={onPress4}>
                        <View
                            style={
                                pressed4 ? styles.btnNormal : styles.btnPress
                            }
                        >
                            <Text
                                style={
                    ...
                    <TouchableWithoutFeedback onPress={onPress}>
                        <View
                            style={pressed ? styles.btnNormal : styles.btnPress}
                        >
                            <Text>WARM</Text>
                        </View>
                    </TouchableWithoutFeedback>
                    <TouchableWithoutFeedback onPress={onPress1}>
                        <View
                            style={
                                pressed1 ? styles.btnNormal : styles.btnPress
                            }
                        >
                            <Text>COOL</Text>
                        </View>
                    ...
                    <TouchableWithoutFeedback onPress={onPress2}>
                        <View
                            style={
                                pressed2 ? styles.btnNormal : styles.btnPress
                            }
                        >
                            <Text> COLD</Text>
                        </View>
                ...
                <View style={styles.inputView2}>
                    <TouchableWithoutFeedback onPress={onPress4S}>
                        <View
                            style={
                                pressed4S ? styles.btnNormal : styles.btnPress
                            }
                        >
                            <Text
                                style={
                    ...
                    <TouchableWithoutFeedback onPress={onPressS}>
                        <View
                            style={
                                pressedS ? styles.btnNormal : styles.btnPress
                            }
                        >
                            <Text> S </Text>
                        </View>
                    ...
                    <TouchableWithoutFeedback onPress={onPress1S}>
                        <View
                            style={
                                pressed1S ? styles.btnNormal : styles.btnPress
                            }
                        >
                            <Text> M </Text>
                        </View>
                    ...
                    <TouchableWithoutFeedback onPress={onPress2S}>
                        <View
                            style={
                                pressed2S ? styles.btnNormal : styles.btnPress
                            }
                        >
                            <Text> L </Text>
                        </View>
                    ...
                    <TouchableWithoutFeedback onPress={onPress3S}>
                        <View
                            style={
                                pressed3S ? styles.btnNormal : styles.btnPress
                            }
                        >
                            <Text> XL </Text>
                        </View>
                    ...
                    <TouchableWithoutFeedback onPress={onPress5S}>
                        <View
                            style={
                                pressed5S ? styles.btnNormal : styles.btnPress
                            }
                        >
                            <Text> XXL </Text>
                        </View>
